...
const renderCarrito = () => {
    ...
    if (cantProductosCarrito() > 0) {
        ...
        productos.forEach(producto => {
            ...
            <td class="align-middle"><button class="btn btn-dark rounded-square" onclick="decrementarCantidadProducto(${producto.id})">-</button> ${producto.cantidad} <button class="btn btn-dark rounded-square" onclick="incrementarCantidadProducto(${producto.id})">+</button></td>
...
const renderProducto = () => {
    ...
    document.getElementById("botonAgregar").innerHTML= `<a href="#" class="btn btn-dark" onclick="agregarProductoCarrito(${producto.id})">Agregar (+)</a>`;
}
